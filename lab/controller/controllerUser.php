...
include_once 'conexao.php';
	...
	switch ($btn) {
		case "inserir":
			$query = "INSERT INTO usuario (nome, matricula, email, funcao) VALUES ('$nomeUser', '$codUser', '$emailUser', '$funUser')";
			$pag = "inserirUser";
			break;
		case "deletar":
			...
			break;
		case "atualizar":
			$query = "UPDATE usuario SET nome = '$nomeUser', email = '$emailUser', funcao = '$funUser' WHERE matricula = '$codUser'";
			$pag = "listarUser";
			break;
		case "cancelar":
			$pag = "listarUser";
...
header("refresh: 0; url=../view/$pag.php");//redireciona para a pagina anterior
}
?>
